...
const aboutContnet = {
	...
	text: "I’m a skilled software developer proficient in TypeScript and JavaScript, with a strong focus on React.js and Next.js. I’m a fast learner who works closely with clients to deliver efficient, scalable, and intuitive solutions that address real-world challenges. Let’s collaborate to turn your vision into reality!",
};

const ServiceCard = ({ index, title, icon, webpIcon }) => (
	<Tilt
		className="sm:w-[250px] w-full"
		options={{ max: 40, scale: 1, speed: 500 }}
	>
		<motion.div
			variants={fadeIn(
				"right",
